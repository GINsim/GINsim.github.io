...
(PVF1, 2 or 3) to the receptor PVR triggers the canonical 
DRK/SOS/RAS/RAF/DSOR1/RL pathway 
[@Duchek2001] [@Bruckner2004] [@Wood2006] [@Harris2007] [@Sims2009].
...
sites for the SH2 domains of proteins such as DRK or CSW [@Vincent1998].
...
through the activation of transcription factors such as the 
ETS-domain-containing protein Pointed (PNT) [@Brunner1994] [@ONeill1994].
The activation of PNT is a major output of the pathway. 
It is either phosphorylated by MAP kinase to 
