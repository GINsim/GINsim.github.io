...
BTL ligand, BNL is encoded by the branchless gene [@Sutherland1996].
...
needed to trigger signal transduction [@Klint1995] [@Kouhara1997].
...
such as DRK or CSW [@Vincent1998].

As a result, DRK recruits the guanine nucleotide exchange factor SOS (Son of
...
(Pointed, with two forms denote by suffixes P1 and P2) [@Brunner1994] [@ONeill1994].
