...
We focus here on the logical modelling developed in [@Thieffry1995]. 
As in this paper, for the sake of explanation clarity, we proceed in two steps. We present a model
...
Note that in [@Chaouiya2008], we considered a modified version of the four component
