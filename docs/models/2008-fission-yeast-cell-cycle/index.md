...
Davidich & Bornholdt [@Davidich2008]. Dynamical rules are defined
...
(Fig. 1, bottom left in [@Faure2009]; see text for more details).
...
defined by Davidich & Bornholdt [@Davidich2008], as well as available
