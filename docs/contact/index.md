...
<div style="display: table; border-spacing: 10px;">
    <div style="display: table-row;">
        <div style="display: table-cell; text-align: center;">
            <img src="ClaudineChaouiya.jpg" alt="Claudine" style="border: none; width: 150px;"><br/>
            <a href="http://claudine.chaouiya.perso.luminy.univ-amu.fr">Claudine Chaouiya</a><br/>
            Project coordination
        </div>
        <div style="display: table-cell; text-align: center;">
            <img src="PedroMonteiro.jpg" alt="Pedro" style="border: none; width: 150px;"><br/>
            <a href="http://pedromonteiro.org">Pedro T. Monteiro</a><br/>
            Software development
        </div>
        <div style="display: table-cell; text-align: center;">
            <img src="AurelienNaldi.jpg" alt="Aurelien" style="border: none; width: 150px;"><br/>
            <a href="http://aurelien.naldi.info">Aur&eacute;lien Naldi</a><br/>
            Software development
        </div>
        <div style="display: table-cell; text-align: center;">
            <img src="DenisThieffry.png" alt="Denis" style="border: none; width: 150px;"><br/>
            <a href="https://www.ibens.ens.fr/spip.php?rubrique27">Denis Thieffry</a><br/>
            Project coordination
        </div>
