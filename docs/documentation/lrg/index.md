...
!!! example "Changing component order"
    ![Changing component order](/documentation/lrg/node_order.png)
...
!!! example "Attributes of a component"
    ![Attributes of a component](/documentation/lrg/geneConfig.png)
...
!!! example "Properties of an interaction arc"
    ![Properties of an interaction arc](/documentation/lrg/interactionConfig.png)
...
!!! example "Definition of non zero parameters for CI"
    ![Definition of non zero parameters for CI](/documentation/lrg/configuredInteraction.png)
...
!!! example "Definition of a logical function for CI"
    ![Definition of a logical function for CI](/documentation/lrg/logical-functions.png)
...
!!! example "The annotation panel"
    ![The annotation panel](/documentation/lrg/annotation.png)
...
!!! example "Perturbation definition panel"
    ![Perturbation definition panel](/documentation/lrg/perturbations.png)
...
!!! example "Perturbation creation panels"
    ![Perturbation creation panels](/documentation/lrg/booleanperturbation.png)
